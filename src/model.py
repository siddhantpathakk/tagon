...
class MergeLayer(torch.nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        # dropout, layer norm and feedforward
...
class SelfAttn(torch.nn.Module):
    ...
    def forward(self, seq, seq_t, mask):
        """"Attention based sequential self attention forward pass
        args:
...
class TGRec(torch.nn.Module):
    def __init__(self, ngh_finder, n_nodes, args,
        ...
        # self.affinity_score = torch.nn.Bilinear(self.feat_dim, self.feat_dim, 1, bias=True)
