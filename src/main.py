...
def parse_opt():
    ...
    parser.add_argument('--file_path', type=str, default='/home/FYP/siddhant005/fyp/data/processed/ml-100k/')
    parser.add_argument('--out_path', type=str, default='/home/FYP/siddhant005/fyp/src/out/tmp/')
