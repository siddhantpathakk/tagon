...
def run(data_name):
    PATH = './datasets/{}/reviews_{}_5.json.gz'.format(data_name, data_name)
    meta_path = './datasets/{}/meta_{}.json.gz'.format(data_name, data_name)
    OUT_DF = './processed/ml_{}.csv'.format(data_name)
    OUT_FEAT = './processed/ml_{}_feat.npy'.format(data_name)
    OUT_NODE_FEAT = './processed/ml_{}_node_feat.npy'.format(data_name)
