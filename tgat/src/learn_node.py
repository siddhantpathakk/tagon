...
g_df = pd.read_csv('./tgat/processed/ml_{}.csv'.format(DATA))
e_feat = np.load('./tgat/processed/ml_{}.npy'.format(DATA))
n_feat = np.load('./tgat/processed/ml_{}_node.npy'.format(DATA))
...
model_path = f'./tgat/saved_models/{args.prefix}-{args.agg_method}-{args.attn_mode}-{DATA}.pth'
...
for epoch in tqdm(range(args.n_epoch)):
    ...
    #torch.save(lr_model.state_dict(), './tgat/saved_models/edge_{}_wkiki_node_class.pth'.format(DATA))
