...
def parse_opt():
    ...
    parser.add_argument('--file_path', type=str, default='/home/FYP/siddhant005/fyp/experiments/reta-gnn/data/processed/ml-100k/')
    parser.add_argument('--out_path', type=str, default='/home/FYP/siddhant005/fyp/experiments/reta-gnn/src/logs/tmp/')
...
if __name__ == '__main__':
    ...
    print('[STATUS] Commencing training for RetaGNN')
